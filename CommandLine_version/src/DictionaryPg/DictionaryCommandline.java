        ...
        do {
            ...
            switch (userAction) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    HangManGame hangman = new HangManGame(Dictionary.getDictionary());
                    hangman.startGame();
                    break;
                case 8:
                    ...
                    break;
                case 9:
                    DictionaryManagement.getDictionaryManagement().ExportToFile("../CommandLine_version/src/testout.txt");
                    break;
                default:
                    return;
            }
