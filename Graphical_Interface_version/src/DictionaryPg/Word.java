...
public class Word implements Cloneable{
    ...
    public String getTextWordTypes() {
        String res = "";
        if (listWordTypes != null) {
            for (WordType iter : listWordTypes) {
            res += iter.toString();
        }
        }
        res += "\n";
    ...
    public String getTextIdioms() {
        String res = "";
        if (listIdioms != null) {
            for (Idioms iter : listIdioms) {
                res += iter.toString();
            }
        }
        res += "\n";
    ...
    public void exportToFile(PrintWriter printWriter) {
        ...
        if (listIdioms != null) {
            // if (word.equals("cunny"))
            // System.out.println("idiom for " + word);
            for (Idioms idioms: listIdioms) {
